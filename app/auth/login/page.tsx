...
export default function LoginPage() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    // Determine destination from user_metadata so we skip an extra server round-trip
    const role = data.user?.user_metadata?.role as string | undefined
    let dest = '/dashboard/teamlid'
    if (role === 'superuser') dest = '/dashboard/superuser'
    else if (role === 'coach') dest = '/dashboard/coach'

    // Hard navigation: browser sends the new session cookies on the next request
